        ...
        <View style={{ flexDirection: 'row'}}>
            <TouchableOpacity onPress={toggleDrawer} >
                <Image
                    source={{
                        uri:
                            'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAMAAAADAAQAAAAB6p1GqAAAAAnRSTlMAAHaTzTgAAAApSURBVHgB7dMxDQAACMRA/JsGAeyQT+7Wzi2AIL38BAF87nPwuc/vAAxHmlzOxpi9vgAAAABJRU5ErkJggg==',
                    }}
